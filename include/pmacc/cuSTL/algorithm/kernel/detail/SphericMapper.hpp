 ...
 */
template<int dim, typename BlockSize = bmp11::mp_void<>, typename dummy = bmp11::mp_void<> >
...
template<>
struct SphericMapper<1, bmp11::mp_void<> >
{
    static constexpr int dim = 1;
...
template<>
struct SphericMapper<2, bmp11::mp_void<> >
{
    static constexpr int dim = 2;
...
template<>
struct SphericMapper<3, bmp11::mp_void<> >
{
    static constexpr int dim = 3;

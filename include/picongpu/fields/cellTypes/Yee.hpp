...
namespace traits
{
     ...
     */
    template<>
    struct FieldPosition<fields::cellTypes::Yee, FieldE, DIM2>
    {
     ...
     */
    template<>
    struct FieldPosition<fields::cellTypes::Yee, FieldE, DIM3>
    {
        /** \tparam float2_X position of the component in the cell
         *  \tparam DIM3     Fields (E/B/J) have 3 components, even in 1 or 2D !
         */
     ...
     */
    template<>
    struct FieldPosition<fields::cellTypes::Yee, FieldB, DIM2>
    {
        /** \tparam float2_X position of the component in the cell
         *  \tparam DIM3     Fields (E/B/J) have 3 components, even in 1 or 2D !
         */
     ...
     */
    template<>
    struct FieldPosition<fields::cellTypes::Yee, FieldB, DIM3>
    {
        /** \tparam float2_X position of the component in the cell
         *  \tparam DIM3     Fields (E/B/J) have 3 components, even in 1 or 2D !
         */
    ...
    struct FieldPosition<fields::cellTypes::Yee, FieldJ, T_simDim> :
        public FieldPosition<fields::cellTypes::Yee, FieldE, T_simDim>
    {
        HDINLINE FieldPosition()
        {
        }
     ...
     */
    template<uint32_t T_simDim>
    struct FieldPosition<fields::cellTypes::Yee, FieldTmp, T_simDim>
    {
